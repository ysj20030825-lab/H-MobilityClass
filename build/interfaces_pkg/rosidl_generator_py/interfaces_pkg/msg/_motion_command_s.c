...
bool interfaces_pkg__msg__motion_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces_pkg.msg._motion_command.MotionCommand", full_classname_dest, 48) == 0);
  }
  interfaces_pkg__msg__MotionCommand * ros_message = _ros_message;
  {  // steering
...
PyObject * interfaces_pkg__msg__motion_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces_pkg.msg._motion_command");
