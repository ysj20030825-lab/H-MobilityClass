...
bool interfaces_pkg__msg__bounding_box3_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces_pkg.msg._bounding_box3_d.BoundingBox3D", full_classname_dest, 49) == 0);
  }
  interfaces_pkg__msg__BoundingBox3D * ros_message = _ros_message;
  {  // center
...
PyObject * interfaces_pkg__msg__bounding_box3_d__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces_pkg.msg._bounding_box3_d");
