...
class KeyPoint3DArray(metaclass=Metaclass_KeyPoint3DArray):
    ...
    _fields_and_field_types = {
        'data': 'sequence<interfaces_pkg/KeyPoint3D>',
        'frame_id': 'string',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['interfaces_pkg', 'msg'], 'KeyPoint3D')),  # noqa: E501
