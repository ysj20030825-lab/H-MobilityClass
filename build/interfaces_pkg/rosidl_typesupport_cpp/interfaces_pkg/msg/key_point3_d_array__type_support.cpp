...
static const _KeyPoint3DArray_type_support_symbol_names_t _KeyPoint3DArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces_pkg, msg, KeyPoint3DArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces_pkg, msg, KeyPoint3DArray)),
  }
};
...
{
  return &::interfaces_pkg::msg::rosidl_typesupport_cpp::KeyPoint3DArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, interfaces_pkg, msg, KeyPoint3DArray)() {
  return get_message_type_support_handle<interfaces_pkg::msg::KeyPoint3DArray>();
}
