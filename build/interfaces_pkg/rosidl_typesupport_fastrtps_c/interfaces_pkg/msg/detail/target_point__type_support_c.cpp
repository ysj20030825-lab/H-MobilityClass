...
#include "interfaces_pkg/msg/detail/target_point__rosidl_typesupport_fastrtps_c.h"
...
using _TargetPoint__ros_msg_type = interfaces_pkg__msg__TargetPoint;
...
static uint32_t _TargetPoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces_pkg__msg__TargetPoint(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces_pkg__msg__TargetPoint;
    is_plain =
      (
...
static size_t _TargetPoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces_pkg__msg__TargetPoint(
