...
#include "interfaces_pkg/msg/detail/bounding_box3_d__rosidl_typesupport_fastrtps_c.h"
...
using _BoundingBox3D__ros_msg_type = interfaces_pkg__msg__BoundingBox3D;
...
static uint32_t _BoundingBox3D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces_pkg__msg__BoundingBox3D(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces_pkg__msg__BoundingBox3D;
    is_plain =
      (
...
static size_t _BoundingBox3D__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces_pkg__msg__BoundingBox3D(
