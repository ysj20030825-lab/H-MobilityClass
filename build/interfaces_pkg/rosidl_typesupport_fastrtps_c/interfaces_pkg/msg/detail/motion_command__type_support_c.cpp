...
#include "interfaces_pkg/msg/detail/motion_command__rosidl_typesupport_fastrtps_c.h"
...
using _MotionCommand__ros_msg_type = interfaces_pkg__msg__MotionCommand;
...
size_t get_serialized_size_interfaces_pkg__msg__MotionCommand(
  const void * untyped_ros_message,
...
static uint32_t _MotionCommand__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces_pkg__msg__MotionCommand(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces_pkg
size_t max_serialized_size_interfaces_pkg__msg__MotionCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces_pkg__msg__MotionCommand;
    is_plain =
      (
...
static size_t _MotionCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces_pkg__msg__MotionCommand(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces_pkg, msg, MotionCommand)() {
