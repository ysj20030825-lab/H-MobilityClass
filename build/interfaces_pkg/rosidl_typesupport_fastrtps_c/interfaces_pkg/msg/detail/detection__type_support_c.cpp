...
#include "interfaces_pkg/msg/detail/bounding_box3_d__functions.h"  // bbox3d
#include "interfaces_pkg/msg/detail/key_point2_d_array__functions.h"  // keypoints
#include "interfaces_pkg/msg/detail/key_point3_d_array__functions.h"  // keypoints3d
...
size_t get_serialized_size_interfaces_pkg__msg__BoundingBox3D(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_interfaces_pkg__msg__BoundingBox3D(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces_pkg, msg, BoundingBox3D)();
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: bbox3d
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, interfaces_pkg, msg, BoundingBox3D
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  // Field name: keypoints
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, interfaces_pkg, msg, KeyPoint2DArray
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  // Field name: keypoints3d
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, interfaces_pkg, msg, KeyPoint3DArray
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_interfaces_pkg__msg__BoundingBox3D(
  ...
  current_alignment += get_serialized_size_interfaces_pkg__msg__KeyPoint2DArray(
    &(ros_message->keypoints), current_alignment);
  // field.name keypoints3d

  current_alignment += get_serialized_size_interfaces_pkg__msg__KeyPoint3DArray(
  ...
  size_t current_alignment)
{
  ...
  // member: bbox3d
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_interfaces_pkg__msg__BoundingBox3D(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // member: keypoints
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_interfaces_pkg__msg__KeyPoint2DArray(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // member: keypoints3d
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_interfaces_pkg__msg__KeyPoint3DArray(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = interfaces_pkg__msg__Detection;
    is_plain =
      (
...
static size_t _Detection__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces_pkg__msg__Detection(
