...
#include "interfaces_pkg/msg/detail/key_point2_d__rosidl_typesupport_fastrtps_c.h"
...
#include "interfaces_pkg/msg/detail/point2_d__functions.h"  // point
...
using _KeyPoint2D__ros_msg_type = interfaces_pkg__msg__KeyPoint2D;
...
static uint32_t _KeyPoint2D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces_pkg__msg__KeyPoint2D(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces_pkg__msg__KeyPoint2D;
    is_plain =
      (
...
static size_t _KeyPoint2D__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces_pkg__msg__KeyPoint2D(
