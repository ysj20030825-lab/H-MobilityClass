...
#include "interfaces_pkg/msg/detail/key_point3_d__rosidl_typesupport_fastrtps_c.h"
...
using _KeyPoint3D__ros_msg_type = interfaces_pkg__msg__KeyPoint3D;
...
static uint32_t _KeyPoint3D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces_pkg__msg__KeyPoint3D(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces_pkg__msg__KeyPoint3D;
    is_plain =
      (
...
static size_t _KeyPoint3D__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces_pkg__msg__KeyPoint3D(
