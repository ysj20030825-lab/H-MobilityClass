...
{
  new (message_memory) interfaces_pkg::msg::TargetPoint(_init);
}

void TargetPoint_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interfaces_pkg::msg::TargetPoint *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TargetPoint_message_member_array[2] = {
  {
    ...
    offsetof(interfaces_pkg::msg::TargetPoint, target_x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces_pkg::msg::TargetPoint, target_y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TargetPoint_message_members = {
  ...
  2,  // number of fields
  sizeof(interfaces_pkg::msg::TargetPoint),
...
{
  return &::interfaces_pkg::msg::rosidl_typesupport_introspection_cpp::TargetPoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces_pkg, msg, TargetPoint)() {
  return &::interfaces_pkg::msg::rosidl_typesupport_introspection_cpp::TargetPoint_message_type_support_handle;
}
