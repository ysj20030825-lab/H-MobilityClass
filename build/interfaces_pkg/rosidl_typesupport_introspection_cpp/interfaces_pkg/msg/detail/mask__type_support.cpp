...
{
  const auto & item = *reinterpret_cast<const interfaces_pkg::msg::Point2D *>(
    get_const_function__Mask__data(untyped_member, index));
  auto & value = *reinterpret_cast<interfaces_pkg::msg::Point2D *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<interfaces_pkg::msg::Point2D *>(
    get_function__Mask__data(untyped_member, index));
  const auto & value = *reinterpret_cast<const interfaces_pkg::msg::Point2D *>(untyped_value);
  item = value;
}
