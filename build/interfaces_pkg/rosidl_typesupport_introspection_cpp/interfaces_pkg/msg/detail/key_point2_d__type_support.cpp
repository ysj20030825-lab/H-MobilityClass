...
{
  new (message_memory) interfaces_pkg::msg::KeyPoint2D(_init);
}

void KeyPoint2D_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interfaces_pkg::msg::KeyPoint2D *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember KeyPoint2D_message_member_array[3] = {
  {
    ...
    offsetof(interfaces_pkg::msg::KeyPoint2D, id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces_pkg::msg::KeyPoint2D, point),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interfaces_pkg::msg::KeyPoint2D, score),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers KeyPoint2D_message_members = {
  ...
  3,  // number of fields
  sizeof(interfaces_pkg::msg::KeyPoint2D),
...
{
  return &::interfaces_pkg::msg::rosidl_typesupport_introspection_cpp::KeyPoint2D_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interfaces_pkg, msg, KeyPoint2D)() {
  return &::interfaces_pkg::msg::rosidl_typesupport_introspection_cpp::KeyPoint2D_message_type_support_handle;
}
