...
{
  const auto & item = *reinterpret_cast<const interfaces_pkg::msg::Detection *>(
    get_const_function__DetectionArray__detections(untyped_member, index));
  auto & value = *reinterpret_cast<interfaces_pkg::msg::Detection *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<interfaces_pkg::msg::Detection *>(
    get_function__DetectionArray__detections(untyped_member, index));
  const auto & value = *reinterpret_cast<const interfaces_pkg::msg::Detection *>(untyped_value);
  item = value;
}
